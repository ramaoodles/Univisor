...
passport.use(new FacebookStrategy({
  ...
  function(accessToken, refreshToken, profile, done) {
    console.log("ww"+accessToken)
    console.log("ww"+profile)
    console.log("ww"+refreshToken)

    // domain.User.findOne({email:profile.email},function(err,user){
    //   if(err){
    //     return done(err);
    //   }
...
var authenticate=function(user,profile){
  if(user==null){
